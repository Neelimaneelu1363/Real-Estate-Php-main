  ...
  <div class="header">
                ...
                <div class="header-left">
					...
					<a href="dashboard.php" class="logo logo-small">
						<img src="assets/img/logomini2.png" alt="Logo" width="30" height="30">
					</a>
                </div>
				<!-- /Logo -->
						...
						<ul>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									...
									<li><a href="availableproperty.php">Available Properties</a></li>
									<li><a href="soldproperties.php">Sold Properties</a></li>
									<li><a href="saleproperty.php">Properties for Sale</a></li>
									<li><a href="rentproperty.php">Properties for Rent</a></li>
